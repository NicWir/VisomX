...
#' @param plot (TRUE or FALSE) Shall the plot be returned in the RStudio 'Plots' pane?
#' @param export (TRUE or FALSE) Shall the plot be exported as PDF and PNG file?
#' @param fontsize (number) Font sized used in the plot.
...
#' @param plot (TRUE or FALSE) Shall the plot be returned in the RStudio 'Plots' pane?
#' @param export (TRUE or FALSE) Shall the plot be exported as PDF and PNG file?
#' @param basesize (number) Font sized used in the plot.
#' @return Density and CumSum plots of intensities of proteins with and without missing values.
#' ((generated by \code{\link[ggplot2]{ggplot}}).
#' @export
met.plot_detect <- function (mSetObj, plot = TRUE, export = TRUE,  basesize = 10)
{
...
#' @param imgName (character) Input a name for the image file (if export = TRUE).
#' @param format (character, "png" or "pdf") image file format (if export = TRUE).
#' @param dpi (number) resolution of the image file (if export = TRUE)?
#' @param width (number) width of the the image file in inch (if export = TRUE)?
#' @param export (TRUE or FALSE) Shall the plot be exported as PDF or PNG file?
#' @param subtitle (TRUE or FALSE) Shall the applied data transformation and scaling methods be displayed below the plot title?
#' @return Scatter plot with the p value for each compound analyzed.
#' ((generated by \code{\link[ggplot2]{ggplot}}).
#' @export
