#' @title Plot a heatmap of compounds with missing values
#'
#' @description \code{met.plot_missval} generates a heatmap of compounds
...
#' @param fontsize (Numeric) Font size used in the plot.
...
#' @title Visualize intensities of compounds with missing values
#'
#' @description \code{met.plot_detect} generates density and CumSum plots
...
#' @param format (Character, \code{"png"} or \code{"pdf"}) image file format (if \code{export = TRUE}).
#' @param export (Logical, \code{TRUE} or \code{FALSE}) Shall the plot be exported as PDF and PNG file?
#' @param basesize (Numeric) Font size used in the plot.
...
#' @importFrom ggplot2 ggplot geom_density stat_density labs guides guide_legend theme_minimal geom_line
...
#' @title Visualize p values determined by ANOVA analysis.
#'
#' @description \code{met.plot_ANOVA} visualizes the significance of each compound in the dataset.
#'
#' @param mSetObj Input name of the created mSet object,
...
#' (generated by \code{\link[ggplot2]{ggplot}}).
#' @importFrom ggplot2 ggplot aes geom_point scale_fill_manual geom_text labs theme_bw theme element_blank element_text geom_hline
...
#' @title Pattern hunter, plot correlation heatmap
#'
#' @description \code{met.plot_CorrHeatMap_Samples} visualizes the correlations between samples.
#'
#' @param mSetObj Input name of the created mSet object.
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
#' @param format (Character, \code{"png"} or \code{"pdf"}) image file format (if \code{export = TRUE}).
...
#' @title Pattern hunter, plot correlation heatmap
#'
#' @description \code{met.plot_CorrHeatMap_Features} visualizes the correlations between features.
#'
#' @param mSetObj Input name of the created mSet object.
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
#' @param format (Character, \code{"png"} or \code{"pdf"}) image file format (if \code{export = TRUE}).
...
#' @title Create 2D PCA score plot
#'
#' @description \code{met.plot_PCA2DScore} visualizes clusters of samples based on their similarity in principal component analysis.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after principal component analysis (\code{\link[VisomX]{met.PCA.Anal}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Plot PCA loadings and also set up the matrix for display
#'
#' @description \code{met.plot_PCA2DLoading} visualizes which features are responsible for the patterns seen among the samples in principal component analysis.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after principal component analysis (\code{\link[VisomX]{met.PCA.Anal}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Create 2D PLS-DA score plot
#'
#' @description \code{met.plot_PLS2DScore} visualizes clusters of samples based on their similarity in partial least squares-discriminant analysis.
#'
#' @param mSetObj Input name of the created mSet object,
...
#' @title Plot PLS-DA loadings and also set up the matrix for display
#'
#' @description \code{met.plot_PLS2DLoading} visualizes which features are responsible for the patterns seen among the samples in partial least squares-discriminant analysis.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Plot PLS important features
#'
#' @description \code{met.plot_PLS_Imp} visualizes the features' importance in the PLS-DA model.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Plot PLS important features
#'
#' @description \code{met.plot_ImpVar} is an internal function used by \code{met.plot_PLS_Imp} to visualize the features' importance in the PLS-DA model.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
...
#' @title Plot PLS important features
#'
#' @description \code{met.plot_PLSImpScatter} visualizes the features' importance in the PLS-DA model by comparing VIP scores and coefficients.
#'
#' @param mSetObj Input name of the created mSet object,
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @author Nicolas T. Wirth \email{mail.nicowirth@gmail.com}
#' @export
#' @importFrom ggplot2 ggplot aes_string geom_point geom_vline ylab theme_bw theme xlab ggtitle
...
#' @title Create heat map of hierarchically clustered features and samples
#'
#' @description \code{met.plot_heatmap} plots a heat map with optional filtering for top features based on results from t-tests/ANOVA, VIP or randomforest.
#'
#' @param mSetObj Input name of the created mSet object.
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
#' @param format (\code{"png"} or \code{"pdf"}) image file format (if \code{export = TRUE}).
...
#' @title Volcano Plot
#'
#' @description \code{met.plot_volcano} generates a volcano plot for a specified contrast.
#'
#' @param mSetObj Input name of the created mSet object,
...
#' @author Nicolas T. Wirth \email{mail.nicowirth@gmail.com}
#' @importFrom ggplot2 ggplot aes geom_point geom_hline geom_vline labs theme_bw theme scale_shape scale_color_manual coord_cartesian
#' @export
...
#' @title Plot a generated 3D PCA scores plot in RStudio
#'
#' @description \code{met.print_PCA3DScore} opens a new graphics device to show the generated 3D PCA score plot.
#'
#' @param mSetObj Input name of the created mSet object.
...
#' @title Create 3D PLS-DA loading plot
#'
#' @description \code{met.plot_PLS3DLoading} visualizes which features are responsible for the patterns seen among the samples in partial least squares-discriminant analysis.
#'
#' @param mSetObj Input name of the created mSet object.
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Plot a generated 3D PLS-DA loading plot in RStudio
#'
#' @description \code{met.print_PLS3DLoading} opens a new graphics device to show the generated 3D PLS-DA loading plot.
#'
#' @param mSetObj Input name of the created mSet object.
...
#' @title Create 3D PLS-DA Score plot
#'
#' @description \code{met.plot_PLS3DScore} visualizes clusters of samples based on their similarity in principal component analysis.
#'
#' @param mSetObj Input name of the created mSet object.
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
...
#' @title Plot a generated 3D PLS-DA scores plot in RStudio
#'
#' @description \code{met.print_PLS3DScore} opens a new graphics device to show the generated 3D PLS-DA score plot.
#'
#' @param mSetObj Input name of the created mSet object.
...
#' @title Plot PLS-DA classification performance using different components
#'
#' @description \code{met.plot_PLS.Crossvalidation} performs cross-validation (CV) on the generated PLS-DA model, where a fraction of data is held back, and the model trained on the rest. In each CV, the predicted data are compared with the original data, and the sum of squared errors is calculated. The prediction error is then summed over all samples (Predicted Residual Sum of Squares or PRESS). For convenience, the PRESS is divided by the initial sum of squares and subtracted from 1 to resemble the scale of the R2. Good predictions will have low PRESS or high Q2. Generally speaking, a model with an R2 (and Q2) value above 0.7 can be considered predictive. It is possible to have negative Q2, which means that your model is not at all predictive or is overfitted.
#'
#' @param mSetObj Input name of the created mSet object.
#' Data container after partial least squares-discriminant analysis (\code{\link[VisomX]{met.PLSR.Anal}} and \code{\link[VisomX]{met.PLSDA.CV}}).
#' @param imgName (Character) Enter a name for the image file (if \code{export = TRUE}).
