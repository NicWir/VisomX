...
```{r ec50_spline_plots, fig.width=3, fig.show='hold', echo=F, warning=F, message=F, fig.align='center'}
...
```{r ec50_boot_plots, fig.width=5, echo=F, warning=F, message=F, fig.align='center'}
for(i in 1:length(grofit$drFit$drBootSplines)){
