...
if(any(c("a", "l") %in% control$fit.opt)){
  ...
  knit_table(table_linear, caption = "Exponential Fit", longtable = TRUE) %>% column_spec(column=1, width_max = "3.5cm")
}
```
...
if(any(c("a", "b", "m") %in% control$fit.opt)){
    ...
    knit_table(table_model, caption = "Parametric Fit", longtable = TRUE) %>% column_spec(column=1, width_max = "4.0cm")
}
```
...
if(any(c("a", "b", "s") %in% control$fit.opt)){
  ...
  knit_table(table_spline, caption = "Smooth Spline Fit", longtable = TRUE) %>% column_spec(column=1, width_max = "4.0cm")
}
```
\clearpage
## Plots
