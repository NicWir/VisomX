...
#### `r nrow(SummarizedExperiment::rowData(dds)[!is.na(SummarizedExperiment::rowData(dds, use.names = FALSE)$significant), ])` genes differ significantly between samples.
...
if (length(contrasts) > 1){
  for (i in 1:length(contrasts)) {
    cat(paste0("* _",
               ...
               "_ genes for contrast ", contrasts[i], "\n"))
  }
}
```
